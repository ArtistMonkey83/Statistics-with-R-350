...
second<-c(295,8)
(result<-first*second)
#result<-choose(300,5)*choose(295,8) one line
...
twoPeople<- factorial(2)*factorial(4)

results<-120 - twoPeople
```
...
fullhouseProb<- fullhouse / totalPossibilities
```
...
#Simulation
bridgeResults<- replicate(10000,{
  deck<-c(rep(1:10,4),rep(10,12),rep(11,4))
  deal13Cards<-sample(deck,13)
  dealSum<-sum (deal13Cards>=10)
  pepsiHand<-dealSum < 1
